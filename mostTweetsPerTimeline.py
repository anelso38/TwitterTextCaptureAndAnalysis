def mostTweetsPerTimeline():
    ...
    INPUT_FILE_PATH = 'C:/Users/##/Desktop/' + INPUTFILE + '.txt' ##ADD USER FILEPATH
    ...
    outputFile = open('C:/Users/##/Desktop/mostTweetsPerTimeline.txt', 'w', encoding = "utf-8") ##ADD USER FILEPATH
